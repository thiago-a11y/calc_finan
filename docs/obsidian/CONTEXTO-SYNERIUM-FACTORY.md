...
**Versão Atual:** v0.58.12 (02/Abr/2026)
...
- **v0.58.12** — **Protecao localStorage no Mission Control** — localStorage access envolvido em try-catch para prevenir erro se storage nao disponivel
