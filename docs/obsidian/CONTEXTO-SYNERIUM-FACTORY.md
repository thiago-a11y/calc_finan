...
**Versão Atual:** v0.58.13 (02/Abr/2026)
...
- **v0.58.13** — **TaskTray com getStoredToken Seguro** — TaskTray recebe mesmo tratamento de protecao localStorage, evitando 401 por localStorage недоступен
