...
from api.routes import status, squads, aprovacoes, rag, standup, usuarios, auth, convites, tarefas, skills, projetos, propostas, uploads, consumo, llm, deploy, videocall, catalogo, luna, code_studio, continuous_factory, mission_control, master_control, kairos
